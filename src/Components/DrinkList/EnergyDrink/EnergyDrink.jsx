...
const EnergyDrink = () => {
  ...
  const coffeeItems = drink_list.filter(item => item.category === 'Energy Drinks');
  ...
  return (
    ...
    <div className='energy-page'><h1>Explore Our EnergyDrink Menu</h1></div>
